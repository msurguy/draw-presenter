...
export const template = {
  name: "Three.js scene",
  description: "A rotating cube skinned by a live WGSL texture (falls back to a plain material)",
  order: 17,
};
  ...
  return (
    <div style={{ position: "absolute", inset: 0 }}>
      ...
      <div style={{ position: "absolute", left: 122, top: 210, fontSize: 26, color: "var(--muted)", maxWidth: 560, lineHeight: 1.5 }}>
        A fragment shader renders to an offscreen canvas; Three.js re-uploads
